...
C {subcells/CDAC/CDAC_12bit.sym} 300 90 0 0 {name=x1}
C {subcells/CDAC/CDAC_12bit.sym} 300 -250 2 1 {name=x2}
C {subcells/switches/switches.sym} -3100 -540 2 1 {name=x3}
C {subcells/switches/switches.sym} -3100 380 0 0 {name=x4}
C {subcells/preamplifier/preamplifier.sym} 1440 -80 0 0 {name=x5}
C {subcells/latched_comparator/latched_comparator.sym} 1780 -80 0 0 {name=x6}
C {subcells/offset_calibration/offset_calibration.sym} 1660 -320 0 1 {name=x7}
C {subcells/state_machine/state_machine.sym} -2590 670 0 0 {name=x8}
C {subcells/bootstrap/bootstrap.sym} -3100 660 0 0 {name=x11}
C {subcells/bootstrap/bootstrap.sym} -3100 850 0 0 {name=x12}
...
C {subcells/break_before_make/break_before_make.sym} -1910 620 0 0 {name=x9}
