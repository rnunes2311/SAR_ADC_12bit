...
C {devices/vsource.sym} 680 -90 0 0 {name=V7 value="pulse(0 1.8 20n 1n 1n 100n 1u)" savecurrent=false}
...
C {devices/vsource.sym} 680 -330 0 0 {name=V8 value="pwl(0 0 10n 0 10.1n 1.8)" savecurrent=false}
...
device=resistor
m=1}
C {devices/vsource.sym} 680 -210 0 0 {name=V9 value="pulse(0 1.8 0 1n 1n 40n 50n)" savecurrent=false}
...
C {devices/vsource.sym} 280 -550 0 0 {name=V11 value="pwl(0 0 3u 0 3.001u 1.8)" savecurrent=false}
