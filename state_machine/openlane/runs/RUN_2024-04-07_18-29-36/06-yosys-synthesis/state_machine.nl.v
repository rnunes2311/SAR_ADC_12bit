...
module state_machine(clk, rst_z, start, en_offset_cal, comp_p, comp_n, vin_p_sw_on, vin_n_sw_on, debug_mux, en_vcm_sw_o_i, vcm_o_i, data, clk_data, sample_o, vcm_o, vref_z_p_o, vref_z_n_o, vss_p_o, vss_n_o, vcm_dummy_o, en_vcm_sw_o
, en_comp, offset_cal_cycle, en_offset_cal_o, debug_out);
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  sky130_fd_sc_hd__nand2b_2 _093_ (
    .A_N(\state[1] ),
    .B(\state[0] ),
    .Y(_031_)
  );
  ...
  sky130_fd_sc_hd__nand2b_2 _103_ (
    .A_N(\state[0] ),
    .B(\state[1] ),
    .Y(_040_)
  );
  sky130_fd_sc_hd__or4bb_2 _104_ (
    .A(\state[0] ),
    .B(debug_mux[0]),
    .C_N(debug_mux[1]),
    .D_N(\state[1] ),
  ...
  sky130_fd_sc_hd__a211oi_2 _109_ (
    .A1(_042_),
    .A2(_044_),
    .B1(debug_mux[3]),
    .C1(debug_mux[2]),
  ...
  sky130_fd_sc_hd__o21ai_2 _120_ (
    .A1(_027_),
    .A2(_031_),
    .B1(_053_),
    .Y(_086_)
  ...
  sky130_fd_sc_hd__nand3b_2 _171_ (
    .A_N(vcm_o_i[0]),
    .B(\result[1] ),
    .C(\counter[1] ),
    .Y(vref_z_n_o[0])
  ...
  sky130_fd_sc_hd__nand3b_2 _173_ (
    .A_N(vcm_o_i[1]),
    .B(\result[2] ),
    .C(\counter[2] ),
    .Y(vref_z_n_o[1])
  ...
  sky130_fd_sc_hd__nand3b_2 _175_ (
    .A_N(vcm_o_i[2]),
    .B(\result[3] ),
    .C(\counter[3] ),
    .Y(vref_z_n_o[2])
  ...
  sky130_fd_sc_hd__nand3b_2 _181_ (
    .A_N(vcm_o_i[5]),
    .B(\result[6] ),
    .C(\counter[6] ),
    .Y(vref_z_n_o[5])
  ...
  sky130_fd_sc_hd__nand3b_2 _183_ (
    .A_N(vcm_o_i[6]),
    .B(\result[7] ),
    .C(\counter[7] ),
    .Y(vref_z_n_o[6])
  ...
  sky130_fd_sc_hd__nand3b_2 _187_ (
    .A_N(vcm_o_i[8]),
    .B(\result[9] ),
    .C(\counter[9] ),
    .Y(vref_z_n_o[8])
  ...
  sky130_fd_sc_hd__nand3b_2 _191_ (
    .A_N(vcm_o_i[10]),
    .B(\result[11] ),
    .C(\counter[11] ),
    .Y(vref_z_n_o[10])
  ...
  sky130_fd_sc_hd__a211oi_2 _195_ (
    .A1(\state[1] ),
    .A2(_030_),
    .B1(_033_),
    .C1(\counter[11] ),
  ...
  sky130_fd_sc_hd__a211o_2 _229_ (
    .A1(\state[1] ),
    .A2(\counter[11] ),
    .B1(_033_),
    .C1(_062_),
